...
mixin _$SuccessfulFullfilment {
  ...
  $SuccessfulFullfilmentCopyWith<SuccessfulFullfilment> get copyWith =>
      _$SuccessfulFullfilmentCopyWithImpl<SuccessfulFullfilment>(
          this as SuccessfulFullfilment, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SuccessfulFullfilment &&
...
abstract mixin class $SuccessfulFullfilmentCopyWith<$Res> {
  factory $SuccessfulFullfilmentCopyWith(SuccessfulFullfilment value,
          $Res Function(SuccessfulFullfilment) _then) =
      _$SuccessfulFullfilmentCopyWithImpl;
  @useResult
  $Res call(
...
class _SuccessfulFullfilment extends SuccessfulFullfilment {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SuccessfulFullfilmentCopyWith<_SuccessfulFullfilment> get copyWith =>
      __$SuccessfulFullfilmentCopyWithImpl<_SuccessfulFullfilment>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SuccessfulFullfilmentToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SuccessfulFullfilment &&
            (identical(other.trackingCompany, trackingCompany) ||
                other.trackingCompany == trackingCompany) &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class _$SuccessfulFullfilmentCopyWith<$Res>
    implements $SuccessfulFullfilmentCopyWith<$Res> {
  factory _$SuccessfulFullfilmentCopyWith(_SuccessfulFullfilment value,
          $Res Function(_SuccessfulFullfilment) _then) =
      __$SuccessfulFullfilmentCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? trackingCompany,

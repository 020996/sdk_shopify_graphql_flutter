...
mixin _$Checkout {
  ...
  $CheckoutCopyWith<Checkout> get copyWith =>
      _$CheckoutCopyWithImpl<Checkout>(this as Checkout, _$identity);
...
abstract mixin class $CheckoutCopyWith<$Res> {
  factory $CheckoutCopyWith(Checkout value, $Res Function(Checkout) _then) =
      _$CheckoutCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      bool ready,
...
class _$CheckoutCopyWithImpl<$Res> implements $CheckoutCopyWith<$Res> {
  ...
  $AvailableShippingRatesCopyWith<$Res>? get availableShippingRates {
    ...
    return $AvailableShippingRatesCopyWith<$Res>(_self.availableShippingRates!,
        (value) {
